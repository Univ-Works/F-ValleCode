...
export const AvatarSection = () => {
    var nameFromURL = localStorage.getItem('usernameFromURL');
    ...
    async function fetchGeneralData() {
        try {
            const url = `http://localhost:8080/usr/data/alldatauser?username=${nameFromURL}`;
                        ...
                        </Label>
                        {
                            username === nameFromURL ? (
                                <Link to="/profile/edit">
                                    <Button className="bg-gradient-to-r from-blue-400 to-blue-600 hover:from-red-300 hover:to-red-500">
                                        <svg
                                            width="15"
                                            height="15"
                                            viewBox="0 0 15 15"
